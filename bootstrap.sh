...
# Start OpenWebUI on 0.0.0.0:8080 for remote access
echo "Starting OpenWebUI on 0.0.0.0:8080..."
nohup open-webui serve --host 0.0.0.0 --port 8080 > /var/log/openwebui.log 2>&1 &
